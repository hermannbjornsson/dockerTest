    ...
    getApiEndpointOptions(url, function(OPTIONS) {
        ...
        case 'POST':
            if (canCreate(OPTIONS)) {
                ...
                showMessage('Acción Prohibida', {
                    style: 'danger',
                    details: 'Operación de creación no permitida',
        ...
        case 'PATCH':
            if (canChange(OPTIONS)) {
                ...
                showMessage('Acción Prohibida', {
                    style: 'danger',
                    details: 'Operación de actualización no permitida',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'DELETE':
            if (canDelete(OPTIONS)) {
                ...
                showMessage('Acción Prohibida', {
                    style: 'danger',
                    details: 'Operación de eliminación no permitida',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'GET':
            if (canView(OPTIONS)) {
                ...
                showMessage('Acción Prohibida', {
                    style: 'danger',
                    details: 'Operación de visualización no permitida',
                    icon: 'fas fa-user-times',
                });
...
function insertPersistButton(options) {
    ...
    var message = options.persistMessage || 'Mantener este formulario abierto';
        ...
        if (field) {
            ...
            case 'decimal':
                if (!validateFormField(name, options)) {
                    ...
                    data_errors[name] = ['Introduzca un número válido'];
                }
                break;
            default:
                break;
...
function constructField(name, parameters, options={}) {
    ...
    if (extra) {
        ...
        if (!parameters.required && !options.hideClearButton) {
            html += `
            <span class='input-group-text form-clear' id='clear_${field_name}' title='Limpiar entrada'>
...
function selectImportFields(url, data={}, options={}) {
    ...
    var headers = `<tr><th>Columna de archivo</th><th>Nombre del campo</th></tr>`;
