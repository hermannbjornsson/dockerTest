        ...
        inventreeGet(`/api/part/${options.part}/serial-numbers/`, {}, {
            success: function(data) {
                if (data.next) {
                    ...
                    options.fields.serial_numbers.placeholder = `Số seri mới nhất: ${data.latest}`;
                }
            },
            async: false,
        });
                        ...
                        inventreeGet(`/api/part/${data.pk}/serial-numbers/`, {}, {
                            success: function(data) {
                                ...
                                if (data.next) {
                                    ...
                                    placeholder = `Số seri mới nhất: ${data.latest}`;
                                }
