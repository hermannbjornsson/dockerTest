...
function deleteSupplierParts(parts, options={}) {
    ...
    Wszystkie wybrane komponenty dostawcy zostaną usunięte
    </div>
    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_customer) {
                    html += `<span title='Klient' class='fas fa-user-tie float-right'></span>`;
                }

                if (row.is_manufacturer) {
                    html += `<span title='Producent' class='fas fa-industry float-right'></span>`;
                }

                if (row.is_supplier) {
                    html += `<span title='Dostawca' class='fas fa-building float-right'></span>`;
                }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'Edytuj komponent producenta');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'Usuń komponent producenta');
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton('button-price-break-edit', row.pk, 'Edytuj przedział cenowy');
