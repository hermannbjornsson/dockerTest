    ...
    inventreeGet(`/api/company/part/${part}/`, {}, {
        success: function(data) {
            ...
            constructForm('/api/company/part/', {
                method: 'POST',
                fields: fields,
                title: 'Duplicar Peça do Fornecedor',
                data: data,
...
function editSupplierPart(part, options={}) {
    ...
    constructForm(`/api/company/part/${part}/`, {
        fields: fields,
        title: options.title || 'Editar Fornecedor da Peça',
        onSuccess: options.onSuccess
    });
}
...
function createSupplierPartPriceBreak(part_id, options={}) {
    ...
    constructForm('/api/company/price-break/', {
        fields: fields,
        method: 'POST',
        title: 'Adicionar parcela de preço',
        onSuccess: function(response) {
            handleFormSuccess(response, options);
        }
    });
    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_supplier) {
                    html += `<span title='Fornecedor' class='fas fa-building float-right'></span>`;
                }
...
function makeManufacturerPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Apagar peças do fabricante',
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'Editar peça do fabricante');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'Excluir peça do fabricante');
...
function makeSupplierPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Excluir peças do fornecedor',
            icon: 'fa-trash-alt icon-red',
            permission: 'purchase_order.delete',
            callback: function(data) {
...
function loadSupplierPartTable(table, url, options) {
    ...
    setupFilterList('supplierpart', $(table), '#filter-list-supplier-part', {
        custom_actions: [
            {
                label: 'supplier-part',
                title: 'Ações de peças do fornecedor',
                icon: 'fa-tools',
