            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Duplica linea');
                            html += makeEditButton('button-edit', pk, 'Modifica linea');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Cancella linea', );
                        }
                    }
