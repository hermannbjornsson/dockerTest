        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_manufacturer) {
                    html += `<span title='製造元' class='fas fa-industry float-right'></span>`;
                }

                if (row.is_supplier) {
                    html += `<span title='仕入先' class='fas fa-building float-right'></span>`;
                }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'メーカー・パーツの編集');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'メーカー・パーツを削除');
