    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_customer) {
                    html += `<span title='Müşteri' class='fas fa-user-tie float-right'></span>`;
                }

                if (row.is_manufacturer) {
                    html += `<span title='Üretici' class='fas fa-industry float-right'></span>`;
                }

                if (row.is_supplier) {
                    html += `<span title='Tedarikçi' class='fas fa-building float-right'></span>`;
                }
...
function makeSupplierPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Tedarikçi parçalarını sil',
            icon: 'fa-trash-alt icon-red',
            permission: 'purchase_order.delete',
            callback: function(data) {
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, 'Tedarikçi parçasını düzenle');
                    html += makeDeleteButton('button-supplier-part-delete', pk, 'Tedarikçi parçasını sil');
