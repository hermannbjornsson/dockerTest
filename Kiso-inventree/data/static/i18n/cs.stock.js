...
function createNewStockItem(options={}) {
    ...
    options.successMessage = 'Položka zásob vytvořena';
...
function locationDetail(row, showLink=true) {
    ...
    if (row.consumed_by) {
        text = 'Spotřebováno podle objednávky';
            ...
            callback: function(data) {
                mergeStockItems(data, {
                    success: function(response) {
                        ...
                        showMessage('Sloučené položky zásob', {
                            style: 'success',
                        });
                    }
                });
    ...
    cols.push({
        ...
        formatter: function(details, row) {
            ...
            if (details.buildorder) {
                html += `<tr><th>Vytvořit objednávku</th>`;
                html += `<td>`;
