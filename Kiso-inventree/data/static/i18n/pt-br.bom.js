...
function constructBomUploadTable(data, options={}) {
    ...
    function constructRow(row, idx, fields) {
        ...
        buttons += makeRemoveButton('button-row-remove', idx, 'Remover linha');
...
function downloadBomTemplate(options={}) {
    ...
    constructFormBody({}, {
        ...
        fields: {
            format: {
                label: 'Formato',
                help_text: 'Selecione o formato de arquivo',
                required: true,
                type: 'choice',
                value: format,
...
function loadBomTable(table, options={}) {
    ...
    if (options.editable) {
        ...
        cols.push({
            ...
            footerFormatter: function(data) {
                return `
                <button class='btn btn-success float-right' type='button' title='Adicionar Item LDM' id='bom-item-new-footer'>
                    ${makeIcon('fa-plus-circle')} Adicionar Item LDM
                </button>
                `;
            }
        });
