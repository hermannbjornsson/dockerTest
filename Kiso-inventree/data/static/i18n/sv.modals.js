...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Skicka</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Skicka');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Skicka';
    var close_text = options.close_text || 'Stäng';
