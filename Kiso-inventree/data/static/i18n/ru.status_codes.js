...
const stockHistoryCodes = {
    ...
    'STOCK_COUNT': {
        key: 10,
        value: 'Склад подсчитан',
        label: 'bg-secondary',
    },
    
    'STOCK_ADD': {
        key: 11,
        value: 'Добавлен вручную',
        label: 'bg-secondary',
    },
    
    'STOCK_REMOVE': {
        key: 12,
        value: 'Удалено вручную',
        label: 'bg-secondary',
    },
    
    'STOCK_MOVE': {
        key: 20,
        value: 'Расположение изменено',
        label: 'bg-secondary',
    },
    ...
    'INSTALLED_INTO_ASSEMBLY': {
        key: 30,
        value: 'Укомплектовано',
        label: 'bg-secondary',
    },
    
    'REMOVED_FROM_ASSEMBLY': {
        key: 31,
        value: 'Удалено из сборки',
        label: 'bg-secondary',
    },
    
    'INSTALLED_CHILD_ITEM': {
        key: 35,
        value: 'Установленный элемент компонента',
        label: 'bg-secondary',
    },
    
    'REMOVED_CHILD_ITEM': {
        key: 36,
        value: 'Удален элемент компонента',
        label: 'bg-secondary',
    },
    ...
    'MERGED_STOCK_ITEMS': {
        key: 45,
        value: 'Объединенные позиции на складе',
        label: 'bg-secondary',
    },
    ...
    'BUILD_OUTPUT_CREATED': {
        key: 50,
        value: 'Создан вывод заказа сборки',
        label: 'bg-secondary',
    },
    
    'BUILD_OUTPUT_COMPLETED': {
        key: 55,
        value: 'Вывод заказа сборки завершён',
        label: 'bg-secondary',
    },
