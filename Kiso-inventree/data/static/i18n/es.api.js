...
function showApiError(xhr, url) {
    ...
    case 0:
        title = 'Sin Respuesta';
        message = 'No hay respuesta del servidor InvenTree';
        break;
    // Bad request
    case 400:
        ...
        message = 'La solicitud API devolvió el código de error 400';
        break;
    // Not authenticated
    case 401:
        title = 'Error 401: No autenticado';
        message = 'Credenciales de autenticación no suministradas';
        break;
    // Permission denied
    case 403:
        title = 'Error 403: Permiso Denegado';
        message = 'No tiene los permisos necesarios para acceder a esta función';
        break;
    // Resource not found
    case 404:
        title = 'Error 404: Recurso No Encontrado';
        message = 'El recurso solicitado no se pudo encontrar en el servidor';
        break;
    // Method not allowed
    case 405:
        title = 'Error 405: Método no Permitido';
        message = 'Método HTTP no permitido en URL';
        break;
    // Timeout
    case 408:
        title = 'Error 408: Tiempo de espera agotado';
        message = 'Tiempo de espera de conexión agotado al solicitar datos del servidor';
        break;
    default:
        title = 'Código de error no controlado';
        message = `Código de error: ${xhr.status}`;
