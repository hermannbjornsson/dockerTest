...
function createManufacturerPart(options={}) {
    ...
    constructForm('/api/company/part/manufacturer/', {
        fields: fields,
        method: 'POST',
        title: 'Fabrikantonderdeel toevoegen',
...
function editManufacturerPart(part, options={}) {
    ...
    constructForm(url, {
        fields: fields,
        title: 'Fabrikantonderdeel bewerken',
        onSuccess: options.onSuccess
    });
}
...
function loadCompanyTable(table, url, options={}) {
    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_customer) {
                    html += `<span title='Klant' class='fas fa-user-tie float-right'></span>`;
                }

                if (row.is_manufacturer) {
                    html += `<span title='Fabrikant' class='fas fa-industry float-right'></span>`;
                }

                if (row.is_supplier) {
                    html += `<span title='Leverancier' class='fas fa-building float-right'></span>`;
                }
    ...
    if (options.pagetype == 'suppliers') {
        ...
        columns.push({
            ...
            title: 'Gefabriceerde Onderdelen',
            formatter: function(value, row) {
...
function deleteManufacturerParts(selections, options={}) {
    ...
    constructForm('/api/company/part/manufacturer/', {
        method: 'DELETE',
        multi_delete: true,
        title: 'Verwijder Fabrikantenonderdelen',
        preFormContent: html,
        form_data: {
            items: ids,
        },
...
function makeManufacturerPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Fabrikantonderdeel verwijderen',
...
function loadManufacturerPartTable(table, url, options) {
    ...
    $(table).inventreeTable({
        ...
        groupBy: false,
        formatNoMatches: function() {
            return 'Geen fabrikantenonderdelen gevonden';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.part_detail.assembly) {
                        html += makeIconBadge('fa-tools', 'Samengesteld onderdeel');
                    }
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'Fabrikant onderdeel bewerken');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'Fabrikant onderdeel verwijderen');
...
function loadManufacturerPartParameterTable(table, url, options) {
    ...
    $(table).inventreeTable({
        ...
        groupBy: false,
        formatNoMatches: function() {
            return 'Geen parameters gevonden';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-parameter-edit', pk, 'Parameter bewerken');
                    html += makeDeleteButton('button-parameter-delete', pk, 'Parameter verwijderen');
...
function makeSupplierPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Verwijder leveranciersonderdelen',
            icon: 'fa-trash-alt icon-red',
            permission: 'purchase_order.delete',
            callback: function(data) {
