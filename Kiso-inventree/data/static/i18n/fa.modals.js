...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>ارسال</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'ارسال');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'ارسال';
    var close_text = options.close_text || 'بستن';
