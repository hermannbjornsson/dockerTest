...
function makeBarcodeInput(placeholderText='', hintText='') {
    ...
    hintText = hintText || 'Wprowadź dane kodu kreskowego';
    ...
    <div class='form-group'>
        <label class='control-label' for='barcode'>Kod kreskowy</label>
        <div class='controls'>
...
function makeNotesField(options={}) {
    ...
    var placeholder = options.placeholder || 'Wprowadź notatki';

    return `
    <div class='form-group'>
        <label class='control-label' for='notes'>Uwagi</label>
        <div class='controls'>
            <div class='input-group'>
                <span class='input-group-text'>
...
function showInvalidResponseError(modal, response, status) {
    showBarcodeMessage(
        modal,
        `Niepoprawna odpowiedź serwera<br>Status: '${status}'`
    );
}
...
function barcodeScanDialog(options={}) {
    ...
    let title = options.title || 'Zeskanuj kod kreskowy';
...
function barcodeCheckInStockItems(location_id, options={}) {
    ...
    barcodeDialog(
        'Scan Stock Items Into Location',
        {
            ...
            headerContent: table,
            preShow: function() {
                modalSetSubmitText(modal, 'Sprawdź');
                modalEnable(modal, false);
                reloadTable();
            },
            onShow: function() {
