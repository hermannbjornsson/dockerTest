...
function createNewStockItem(options={}) {
    ...
    options.successMessage = 'Lagerpost skapad';
            ...
            callback: function(data) {
                mergeStockItems(data, {
                    success: function(response) {
                        ...
                        showMessage('Sammanfogade lagerposter', {
                            style: 'success',
                        });
                    }
                });
    ...
    cols.push({
        ...
        formatter: function(details, row) {
            ...
            if (details.salesorder) {
                html += `<tr><th>Försäljningsorder</th>`;
                html += '<td>';
