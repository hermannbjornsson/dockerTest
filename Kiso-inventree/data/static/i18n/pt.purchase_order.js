...
function createPurchaseOrder(options={}) {
    ...
    constructForm('/api/order/po/', {
        ...
        title: options.title || 'Criar Pedido de compra',
    });
}
        ...
        part: {
            ...
            onEdit: function(value, name, field, opts) {
                ...
                inventreeGet(`/api/company/part/${value}/`,
                    ...
                    if (pack_quantity != 1) {
                        var txt = `<span class='fas fa-info-circle icon-blue'></span> Quantidade de embalagens: ${formatDecimal(pack_quantity)} ${units}`;
...
function orderParts(parts_list, options={}) {
    ...
    <table class='table table-striped table-condensed' id='order-parts-table'>
        <thead>
            <tr>
                <th>Peça</th>
                <th style='min-width: 300px;'>Fornecedor da Peça</th>
                <th style='min-width: 300px;'>Pedido de Compra</th>
                <th style='min-width: 50px;'>Quantidade</th>
                <th><!-- Actions --></th>
            </tr>
        </thead>
        <tbody>
                ...
                var onSupplierPartChanged = function(value, name, field, opts) {
                    ...
                    if (value != null) {
                        inventreeGet(
                            ...
                            if (pack_quantity != 1) {
                                var txt = `<span class='fas fa-info-circle icon-blue'></span> Quantidade de embalagens: ${pack_quantity} ${units}`;
    ...
    function renderLineItem(line_item, opts={}) {
        ...
        if (native_pack_quantity != 1) {
            ...
            <div class='alert alert-small alert-block alert-info'>
                Quantidade de embalagens: ${pack_quantity}<br>
        ...
        var batch_input = constructField(
            `items_batch_code_${pk}`,
            {
                ...
                help_text: 'Digite o código do lote para itens de estoque recebidos',
                icon: 'fa-layer-group',
            },
            {
                hideLabels: true,
        ...
        var sn_input = constructField(
            `items_serial_numbers_${pk}`,
            {
                ...
                help_text: 'Digite o número de série para itens de estoque recebidos',
                icon: 'fa-hashtag',
            },
            {
                hideLabels: true,
        ...
        if (line_items.length > 1) {
            buttons += makeRemoveButton('button-row-remove', pk, 'Remover linha');
        }
                ...
                $(opts.modal).find('.button-row-add-barcode').click(function() {
                    ...
                    barcodeDialog('Scan Item Barcode', {
                        ...
                        onScan: function(response, barcode_options) {
                            ...
                            showBarcodeMessage(barcode_options.modal, 'Código de barras corresponde ao item existente');
                        },
    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Referencia do fornecedor',
            },
            {
                field: 'description',
                title: 'Descricao',
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.supplier_part_detail && row.supplier_part_detail.pack_quantity_native != 1.0) {
                        ...
                        data += `<span class='fas fa-info-circle icon-blue float-right' title='Quantidade de embalagens: ${pack_quantity} - Quantidade Total: ${total}${units}'></span>`;
                    }
