            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Duplicar línea');
                            html += makeEditButton('button-edit', pk, 'Editar línea');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Eliminar línea', );
                        }
                    }
