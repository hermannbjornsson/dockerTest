...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Odeslat</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Odeslat');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Odeslat';
    var close_text = options.close_text || 'Zavřít';
