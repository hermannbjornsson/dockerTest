    ...
    getApiEndpointOptions(url, function(OPTIONS) {
        ...
        case 'POST':
            if (canCreate(OPTIONS)) {
                ...
                showMessage('Handling forbudt', {
                    style: 'danger',
                    details: 'Opprett-operasjon ikke tillatt',
        ...
        case 'PATCH':
            if (canChange(OPTIONS)) {
                ...
                showMessage('Handling forbudt', {
                    style: 'danger',
                    details: 'Oppdater-operasjon ikke tillatt',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'DELETE':
            if (canDelete(OPTIONS)) {
                ...
                showMessage('Handling forbudt', {
                    style: 'danger',
                    details: 'Slett-operasjon ikke tillatt',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'GET':
            if (canView(OPTIONS)) {
                ...
                showMessage('Handling forbudt', {
                    style: 'danger',
                    details: 'Vis-operasjon ikke tillatt',
                    icon: 'fas fa-user-times',
                });
...
function insertConfirmButton(options) {
    ...
    var message = options.confirmMessage || 'Bekreft';
...
function insertPersistButton(options) {
    ...
    var message = options.persistMessage || 'Holde dette skjemaet åpent';
        ...
        if (field) {
            ...
            case 'decimal':
                if (!validateFormField(name, options)) {
                    ...
                    data_errors[name] = ['Angi et gyldig nummer'];
                }
                break;
            default:
                break;
...
function constructField(name, parameters, options={}) {
    ...
    if (extra) {
        ...
        if (!parameters.required && !options.hideClearButton) {
            html += `
            <span class='input-group-text form-clear' id='clear_${field_name}' title='Tøm inndata'>
...
function selectImportFields(url, data={}, options={}) {
    ...
    var headers = `<tr><th>Filkolonne</th><th>Feltnavn</th></tr>`;
