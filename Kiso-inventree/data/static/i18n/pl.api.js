...
function showApiError(xhr, url) {
    ...
    case 0:
        ...
        message = 'Brak odpowiedzi z serwera InvenTree';
        break;
    // Bad request
    case 400:
        // Note: Normally error code 400 is handled separately,
        //       and should now be shown here!
        title = 'Błąd 400: Błędne żądanie';
        message = 'Żądanie interfejsu API zwróciło kod błędu 400';
        break;
    // Not authenticated
    case 401:
        title = 'Błąd 401: Nieuwierzytelniony';
        message = 'Dane uwierzytelniające nie zostały dostarczone';
        break;
    // Permission denied
    case 403:
        title = 'Błąd 403: Odmowa dostępu';
        message = 'Nie masz uprawnień wymaganych do dostępu do tej funkcji';
        break;
    // Resource not found
    case 404:
        title = 'Błąd 404: Nie znaleziono zasobu';
        message = 'Żądany zasób nie mógł być zlokalizowany na serwerze';
        break;
    // Method not allowed
    case 405:
        title = 'Błąd 405: Metoda nie jest dozwolona';
        message = 'Metoda HTTP nie jest dozwolona pod tym adresem URL';
        break;
    // Timeout
    case 408:
        title = 'Błąd 408: Przekroczony limit czasu';
        message = 'Limit czasu połączenia podczas żądania danych z serwera';
        break;
    default:
        title = 'Nieobsługiwany kod błędu';
        message = `Kod błędu: ${xhr.status}`;
