        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.is_builtin) {
                        html += `<span class='badge bg-success rounded-pill badge-right'>Integrato</span>`;
                    }

                    if (row.is_sample) {
                        html += `<span class='badge bg-info rounded-pill badge-right'>Esempio</span>`;
                    }
...
function installPlugin() {
    constructForm(`/api/plugins/install/`, {
        ...
        onSuccess: function(data) {
            let msg = 'Il Plugin è stato installato';
