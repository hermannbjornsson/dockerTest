    ...
    getApiEndpointOptions(url, function(OPTIONS) {
        ...
        case 'POST':
            if (canCreate(OPTIONS)) {
                ...
                showMessage('Action Prohibited', {
                    style: 'danger',
                    details: 'Операция создания не разрешена',
        ...
        case 'PATCH':
            if (canChange(OPTIONS)) {
                ...
                showMessage('Action Prohibited', {
                    style: 'danger',
                    details: 'Операция обновления не разрешена',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'DELETE':
            if (canDelete(OPTIONS)) {
                ...
                showMessage('Action Prohibited', {
                    style: 'danger',
                    details: 'Операция удаления не разрешена',
                    icon: 'fas fa-user-times',
                });
        ...
        case 'GET':
            if (canView(OPTIONS)) {
                ...
                showMessage('Action Prohibited', {
                    style: 'danger',
                    details: 'Операция просмотра не разрешена',
                    icon: 'fas fa-user-times',
                });
