            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Position duplizieren');
                            html += makeEditButton('button-edit', pk, 'Zeile bearbeiten');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Zeile löschen', );
                        }
                    }
