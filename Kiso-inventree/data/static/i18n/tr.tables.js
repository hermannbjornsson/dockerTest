...
function constructOrderTableButtons(options={}) {
    ...
    if (!options.disableCalendarView) {
        buttons.push({
            html: `<button type='button' name='${idx++}' class='btn ${class_calendar}' title='Takvim görünümünü görüntüle'><span class='fas fa-calendar-alt'></span></button>`,
            event: function() {
    ...
    if (!options.disableListView) {
        buttons.push({
            html: `<button type='button' name='${idx++}' class='btn ${class_list}' title='Liste görünümünü görüntüle'><span class='fas fa-th-list'></span></button>`,
            event: function() {
                buttonCallback('list');
            }
        });
    ...
    $.fn.bootstrapTable.locales['en-US-custom'] = {
        ...
        formatShowingRows: function(pageFrom, pageTo, totalRows) {
            ...
            if (totalRows === undefined || isNaN(totalRows)) {
                ...
                return `Gösteriliyor ${pageFrom} için ${pageTo} yüzünden ${totalRows} satırlar`;
            }
        },
