...
function makeBarcodeInput(placeholderText='', hintText='') {
    ...
    <div class='form-group'>
        <label class='control-label' for='barcode'>Viivakoodi</label>
        <div class='controls'>
...
function makeNotesField(options={}) {
    ...
    return `
    <div class='form-group'>
        <label class='control-label' for='notes'>Merkinnät</label>
        <div class='controls'>
            <div class='input-group'>
                <span class='input-group-text'>
...
function showInvalidResponseError(modal, response, status) {
    showBarcodeMessage(
        modal,
        `Invalid server response<br>Tila: '${status}'`
    );
}
...
function barcodeScanDialog(options={}) {
    ...
    let title = options.title || 'Skannaa viivakoodi';
...
function unlinkBarcode(data, options={}) {
    ...
    var html = `<b>Poista viivakoodin linkitys</b><br>`;

    html += 'This will remove the link to the associated barcode';

    showQuestionDialog(
        'Poista viivakoodin linkitys',
        html,
        {
            accept_text: 'Unlink',
            accept: function() {
