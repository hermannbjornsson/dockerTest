...
function loadBomPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Ingen BOM-data tilgjengelig';
        },
...
function loadPartSupplierPricingTable(options={}) {
    ...
    table.inventreeTable({
        ...
        onLoadSuccess: function(data) {
            ...
            var graphLabels = Array.from(data, (x) => (`${x.part_detail.SKU} - Antall ${x.quantity}`));
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeDeleteButton(`button-${name}-delete`, row.pk, `Slett ${human_name}"`);
