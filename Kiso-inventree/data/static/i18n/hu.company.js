...
function createManufacturerPart(options={}) {
    ...
    constructForm('/api/company/part/manufacturer/', {
        fields: fields,
        method: 'POST',
        title: 'Gyártói alkatrész hozzáadása',
...
function editManufacturerPart(part, options={}) {
    ...
    constructForm(url, {
        fields: fields,
        title: 'Gyártói alkatrész szerkesztése',
        onSuccess: options.onSuccess
    });
}
    ...
    inventreeGet(`/api/company/part/${part}/`, {}, {
        success: function(data) {
            ...
            constructForm('/api/company/part/', {
                method: 'POST',
                fields: fields,
                title: 'Beszállítói alkatrész másolása',
                data: data,
...
function editSupplierPart(part, options={}) {
    ...
    constructForm(`/api/company/part/${part}/`, {
        fields: fields,
        title: options.title || 'Beszállítói alkatrész szerkesztése',
        onSuccess: options.onSuccess
    });
}
...
function deleteSupplierParts(parts, options={}) {
    ...
    Az összes kiválasztott beszállítói alkatrész törölve lesz
    </div>
    ...
    constructForm('/api/company/part/', {
        method: 'DELETE',
        multi_delete: true,
        title: 'Beszállítói alkatrészek törlése',
        preFormContent: html,
        form_data: {
            items: ids,
        },
...
function loadCompanyTable(table, url, options={}) {
    ...
    var columns = [
        ...
        },
        {
            ...
            formatter: function(value, row) {
                ...
                if (row.is_customer) {
                    html += `<span title='Vevő' class='fas fa-user-tie float-right'></span>`;
                }

                if (row.is_manufacturer) {
                    html += `<span title='Gyártó' class='fas fa-industry float-right'></span>`;
                }

                if (row.is_supplier) {
                    html += `<span title='Beszállító' class='fas fa-building float-right'></span>`;
                }
    ...
    if (options.pagetype == 'suppliers') {
        columns.push({
            ...
            title: 'Beszállított alkatrészek',
            formatter: function(value, row) {
    ...
    $(table).inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nem található céginformáció';
        },
        showColumns: true,
...
function deleteContacts(contacts, options={}) {
    ...
    let html = `
    <div class='alert alert-block alert-danger'>
    A kiválasztott névjegyek törlésre kerülnek
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Név</th>
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        html += makeEditButton('btn-contact-edit', pk, 'Névjegy szerkesztése');
                    }

                    if (options.allow_delete) {
                        html += makeDeleteButton('btn-contact-delete', pk, 'Névjegy törlése');
                    }
...
function deleteManufacturerParts(selections, options={}) {
    ...
    var html = `
    <div class='alert alert-block alert-danger'>
    Az összes kijelölt gyártói alkatrész törlésre kerül
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Alkatrész</th>
    ...
    constructForm('/api/company/part/manufacturer/', {
        method: 'DELETE',
        multi_delete: true,
        title: 'Gyártói alkatrészek törlése',
        preFormContent: html,
        form_data: {
            items: ids,
        },
...
function deleteManufacturerPartParameters(selections, options={}) {
    ...
    var html = `
    <div class='alert alert-block alert-danger'>
    Az összes kijelölt paraméter törlésre kerül
    </div>
    <table class='table table-striped table-condensed'>
    <tr>
        <th>Név</th>
...
function loadManufacturerPartTable(table, url, options) {
    ...
    $(table).inventreeTable({
        ...
        groupBy: false,
        formatNoMatches: function() {
            return 'Nincs gyártói alkatrész';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, 'Gyártói alkatrész szerkesztése');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, 'Gyártói alkatrész törlése');
...
function makeSupplierPartActions(options={}) {
    return [
        ...
        {
            label: 'delete',
            title: 'Beszállítói alkatrész törlése',
            icon: 'fa-trash-alt icon-red',
            permission: 'purchase_order.delete',
            callback: function(data) {
...
function loadSupplierPartTable(table, url, options) {
    ...
    setupFilterList('supplierpart', $(table), '#filter-list-supplier-part', {
        custom_actions: [
            {
                label: 'supplier-part',
                title: 'Beszállítói alkatrész műveletek',
                icon: 'fa-tools',
    ...
    $(table).inventreeTable({
        ...
        sortable: true,
        formatNoMatches: function() {
            return 'Nincs beszállítói alkatrész';
        },
        columns: [
            {
                checkbox: true,
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, 'Beszállítói alkatrész szerkesztése');
                    html += makeDeleteButton('button-supplier-part-delete', pk, 'Beszállítói alkatrész törlése');
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton('button-price-break-edit', row.pk, 'Ársáv szerkesztése');
                    buttons += makeDeleteButton('button-price-break-delete', row.pk, 'Ársáv törlése');
