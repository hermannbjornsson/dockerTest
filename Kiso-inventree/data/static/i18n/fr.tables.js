...
function constructOrderTableButtons(options={}) {
    ...
    if (!options.disableCalendarView) {
        buttons.push({
            html: `<button type='button' name='${idx++}' class='btn ${class_calendar}' title='Affichage du calendrier'><span class='fas fa-calendar-alt'></span></button>`,
            event: function() {
    ...
    if (!options.disableListView) {
        buttons.push({
            html: `<button type='button' name='${idx++}' class='btn ${class_list}' title='Affichage en liste'><span class='fas fa-th-list'></span></button>`,
            event: function() {
                buttonCallback('list');
            }
        });
...
(function($) {
    ...
    $.fn.bootstrapTable.locales['en-US-custom'] = {
        ...
        formatRecordsPerPage: function(pageNumber) {
            return `${pageNumber} résultats par page`;
        },
        formatShowingRows: function(pageFrom, pageTo, totalRows) {

            if (totalRows === undefined || isNaN(totalRows)) {
                return 'Afficher toutes les lignes';
            } else {
                return `Afficher ${pageFrom} à ${pageTo} de ${totalRows} lignes`;
            }
        },
        ...
        formatNoMatches: function() {
            return 'Aucun résultat correspondant n\'a été trouvé';
        },
