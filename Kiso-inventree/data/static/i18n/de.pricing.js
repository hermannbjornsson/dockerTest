...
function calculateTotalPrice(dataset, value_func, currency_func, options={}) {
    ...
    if (!rates) {
        ...
        return `<span class='icon-red fas fa-exclamation-circle' title='Fehler beim Abrufen der Währungsdaten'></span>`;
    }
...
function loadBomPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Keine Stücklisten-Daten verfügbar';
        },
...
function loadPartSupplierPricingTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Keine Zulieferer-Preise verfügbar';
        },
        onLoadSuccess: function(data) {
            ...
            var graphLabels = Array.from(data, (x) => (`${x.part_detail.SKU} - Anzahl ${x.quantity}`));
...
function loadPriceBreakTable(table, options={}) {
    ...
    table.inventreeTable({
        ...
        method: 'get',
        formatNoMatches: function() {
            return `Keine Staffelpreisdaten verfügbar`;
        },
        queryParams: {
            part: options.part
        },
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton(`button-${name}-edit`, row.pk, `Bearbeiten ${human_name}`);
...
function loadPurchasePriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Keine Einkaufshistorie verfügbar';
        },
        onLoadSuccess: function(data) {
...
function loadSalesPriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Keine Verkaufshistorie verfügbar';
        },
        onLoadSuccess: function(data) {
...
function loadVariantPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Keine Variantendaten verfügbar';
        },
        onLoadSuccess: function(data) {
