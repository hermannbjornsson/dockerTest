...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>שלח</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'שלח');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'שלח';
    var close_text = options.close_text || 'סגירה';
