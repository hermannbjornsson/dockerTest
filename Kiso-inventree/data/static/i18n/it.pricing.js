...
function calculateTotalPrice(dataset, value_func, currency_func, options={}) {
    ...
    if (!rates) {
        ...
        return `<span class='icon-red fas fa-exclamation-circle' title='Errore durante il recupero dati'></span>`;
    }
...
function loadBomPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        formatNoMatches: function() {
            return 'Nessun dato Distinta Base disponibile';
        },
...
function loadPartSupplierPricingTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nessun dato di prezzo disponibile per il fornitore';
        },
        onLoadSuccess: function(data) {
            ...
            var graphLabels = Array.from(data, (x) => (`${x.part_detail.SKU} - Quantità ${x.quantity}`));
...
function loadPriceBreakTable(table, options={}) {
    ...
    table.inventreeTable({
        ...
        method: 'get',
        formatNoMatches: function() {
            return `Nessun dato disponibile prezzo limite`;
        },
        queryParams: {
            part: options.part
        },
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton(`button-${name}-edit`, row.pk, `Modifica ${human_name}`);
                    buttons += makeDeleteButton(`button-${name}-delete`, row.pk, `Elimina ${human_name}"`);
...
function loadPurchasePriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nessun dato della cronologia di acquisto disponibile';
        },
        onLoadSuccess: function(data) {
            ...
            chart = loadBarChart(chartElement, {
                ...
                datasets: [
                    {
                        label: 'Cronologia Prezzi Acquisto',
                        data: graphValues,
                        backgroundColor: 'rgba(255, 206, 86, 0.2)',
                        borderColor: 'rgb(255, 206, 86)',
                        stepped: true,
...
function loadSalesPriceHistoryTable(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Nessun dato della cronologia di vendita disponibile';
        },
        onLoadSuccess: function(data) {
            ...
            chart = loadBarChart(chartElement, {
                ...
                datasets: [
                    {
                        label: 'Cronologia Prezzo Vendita',
                        data: graphValues,
                        backgroundColor: 'rgba(255, 206, 86, 0.2)',
                        borderColor: 'rgb(255, 206, 86)',
                        stepped: true,
...
function loadVariantPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'Non sono disponibili dati varianti';
        },
        onLoadSuccess: function(data) {
