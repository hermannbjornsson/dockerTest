...
function showApiError(xhr, url) {
    ...
    case 400:
        ...
        message = 'Fehler-Code 400 zurückgegeben';
        break;
    // Not authenticated
    case 401:
        title = 'Fehler 401: Nicht Angemeldet';
        message = 'Authentication Kredentials nicht angegeben';
        break;
    // Permission denied
    case 403:
        title = 'Fehler 403: keine Berechtigung';
        message = 'Fehlende Berechtigung für diese Aktion';
        break;
    // Resource not found
    case 404:
        title = 'Fehler 404: Ressource nicht gefunden';
        message = 'Die angefragte Ressource kann auf diesem Server nicht gefunden werden';
        break;
    // Method not allowed
    case 405:
    ...
    case 408:
        ...
        message = 'Verbindungszeitüberschreitung bei der Datenanforderung';
        break;
    default:
        title = 'Unbehandelter Fehler-Code';
        message = `Fehler-Code: ${xhr.status}`;
