...
function receiveReturnOrderItems(order_id, line_items, options={}) {
    ...
    constructForm(`/api/order/ro/${order_id}/receive/`, {
        ...
        title: 'Recibir artículos de pedido de devolución',
    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Ítem',
                formatter: function(value, row) {
                    return renderLink(`Número de serie: ${row.item_detail.serial}`, `/stock/item/${row.item}/`);
                }
            },
            {
                field: 'reference',
                ...
                formatter: function(value, row) {
                    ...
                    if (options.allow_edit) {
                        ...
                        if (options.allow_receive && !row.received_date) {
                            buttons += makeIconButton('fa-sign-in-alt icon-green', 'button-line-receive', pk, 'Marcar artículo como recibido');
                        }
