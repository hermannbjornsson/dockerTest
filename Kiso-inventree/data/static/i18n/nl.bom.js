...
function constructBomUploadTable(data, options={}) {
    ...
    function constructRow(row, idx, fields) {
        ...
        buttons += makeRemoveButton('button-row-remove', idx, 'Rij verwijderen');
...
function downloadBomTemplate(options={}) {
    ...
    constructFormBody({}, {
        ...
        fields: {
            format: {
                label: 'Formaat',
                help_text: 'Selecteer bestandsindeling',
                required: true,
                type: 'choice',
                value: format,
...
function exportBom(part_id, options={}) {
    ...
    constructFormBody({}, {
        ...
        fields: {
            ...
            manufacturer_data: {
                label: 'Voeg Fabrikantgegevens toe',
                help_text: 'Voeg onderdeelfabrikantgegevens toe aan geëxporteerde stuklijst',
                type: 'boolean',
...
function bomSubstitutesDialog(bom_item_id, substitutes, options={}) {
    ...
    var html = `
    <div class='alert alert-block'>
    <strong>Basis onderdeel</strong><hr>
    ...
    cols.push({
        ...
        formatter: function(value, row) {
            ...
            if (available_stock <= 0) {
                text += makeIconBadge('fa-times-circle icon-red', 'Geen Voorraad Aanwezig');
            } else {
                var extra = '';
