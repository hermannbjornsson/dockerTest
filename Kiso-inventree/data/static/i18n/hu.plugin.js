        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.is_builtin) {
                        html += `<span class='badge bg-success rounded-pill badge-right'>Beépített</span>`;
                    }

                    if (row.is_sample) {
                        html += `<span class='badge bg-info rounded-pill badge-right'>Minta</span>`;
                    }
...
function installPlugin() {
    constructForm(`/api/plugins/install/`, {
        ...
        onSuccess: function(data) {
            let msg = 'A plugin telepítve lett';
