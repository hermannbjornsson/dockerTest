...
function loadPartSupplierPricingTable(options={}) {
    ...
    table.inventreeTable({
        ...
        onLoadSuccess: function(data) {
            ...
            var graphLabels = Array.from(data, (x) => (`${x.part_detail.SKU} - Cantidad ${x.quantity}`));
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    buttons += makeEditButton(`button-${name}-edit`, row.pk, `Editar ${human_name}`);
...
function loadVariantPricingChart(options={}) {
    ...
    table.inventreeTable({
        ...
        showColumns: false,
        formatNoMatches: function() {
            return 'No hay datos de variantes disponibles';
        },
        onLoadSuccess: function(data) {
