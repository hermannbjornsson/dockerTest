...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Ajukan</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Ajukan');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Ajukan';
    var close_text = options.close_text || 'Tutup';
