...
function createPart(options={}) {
    ...
    constructForm('/api/part/', {
        ...
        title: 'Luo osa',
        persist: true,
        persistMessage: 'Luo toinen osa tämän jälkeen',
        successMessage: 'Osan luonti onnistui',
    ...
    if (part.total_in_stock) {
        ...
        if ((part.minimum_stock > 0) && (part.minimum_stock > part.total_in_stock)) {
            ...
            if (options.hideTotalStock) {
                elements.push(`Saatavilla: ${part.unallocated_stock}`);
            } else {
                elements.push(`Saatavilla: ${part.unallocated_stock}/${part.in_stock}`);
            }
        } else {
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.received >= row.quantity) {
                        // Already received
                        return `<span class='badge bg-success rounded-pill'>Vastaanotettu</span>`;
