            ...
            if (!allocations || allocations.length == 0) {
                ...
                allocations.forEach(function(allocation) {
                    ...
                    if (allocation.serial) {
                        stock = `Número de Sério: ${allocation.serial}`;
                    } else {
                        stock = `Quantidade: ${allocation.quantity}`;
                    }
...
function completeSalesOrder(order_id, options={}) {
    ...
    constructForm(
        ...
        {
            method: 'POST',
            title: 'Concluir Pedido de Venda',
            confirm: true,
            ...
            preFormContent: function(opts) {
                ...
                if (opts.context.pending_shipments) {
                    html += `
                    <div class='alert alert-block alert-danger'>
                    Pedido não pode ser concluído, pois, há envios incompletos<br>
                    </div>`;
                }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    var text = `Item de estoque ${row.item}`;
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    let text = `Quantidade: ${row.quantity}`;

                    if (item && item.serial != null && row.quantity == 1) {
                        text = `Número de Sério: ${item.serial}`;
                    }
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (row.shipment_date) {
                        ...
                        // Location specified
                        return renderLink(
                            row.location_detail.pathstring || 'Local',
