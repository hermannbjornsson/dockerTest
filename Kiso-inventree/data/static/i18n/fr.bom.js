...
function constructBomUploadTable(data, options={}) {
    ...
    function constructRow(row, idx, fields) {
        ...
        buttons += makeRemoveButton('button-row-remove', idx, 'Supprimer la ligne');
...
function downloadBomTemplate(options={}) {
    ...
    constructFormBody({}, {
        title: 'Télécharger le template de la BOM',
        fields: {
            format: {
                label: 'Format',
                help_text: 'Sélectionner un format de fichier',
                required: true,
                type: 'choice',
                value: format,
...
function exportBom(part_id, options={}) {
    ...
    constructFormBody({}, {
        ...
        fields: {
            ...
            levels: {
                label: 'Niveaux',
                help_text: 'Sélectionner le nombre maximum de niveaux de BOM à exporter (0 = tous les niveaux)',
                type: 'integer',
                value: 0,
                required: true,
                min_value: 0,
