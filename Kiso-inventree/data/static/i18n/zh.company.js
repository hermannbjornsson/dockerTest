        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-manufacturer-part-edit', pk, '编辑制造商商品');
                    html += makeDeleteButton('button-manufacturer-part-delete', pk, '删除生产商商品');
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    html += makeEditButton('button-supplier-part-edit', pk, '编辑供应商商品');
                    html += makeDeleteButton('button-supplier-part-delete', pk, '删除供应商商品');
