    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Elemento',
                formatter: function(value, row) {
                    return renderLink(`Numero Seriale: ${row.item_detail.serial}`, `/stock/item/${row.item}/`);
                }
            },
            {
                field: 'reference',
