        ...
        preFormContent: function(opts) {
            ...
            if (ctx.allocated && ctx.remaining == 0 && ctx.incomplete == 0) {
                ...
                if (ctx.incomplete > 0) {
                    ...
                    <strong>Order memiliki hasil produksi yang belum dilengkapi</strong><br>
                ...
                if (!ctx.allocated) {
                    html += `<div class='alert alert-block alert-warning'>Stok yang diperlukan belum teralokasikan sepenuhnya</div>`;
                }

                if (ctx.remaining > 0) {
                    html += `<div class='alert alert-block alert-warning'>Jumlah produksi yang diperlukan masih belum cukup</div>`;
                }
            }
...
function renderBuildOutput(output, options={}) {
    ...
    if (output.quantity == 1 && output.serial) {
        ...
        output_html += `Jumlah: ${output.quantity}`;
    ...
    <table class='table table-striped table-condensed' id='stock-allocation-table'>
        <thead>
            <tr>
                <th>Bagian</th>
                <th>Allocated</th>
                <th style='min-width: 250px;'>Stok Item</th>
                <th>Jumlah</th>
                <th></th>
            </tr>
        </thead>
