...
function createNewModal(options={}) {
    ...
    if (!options.hideCloseButton) {
        buttons += `<button type='button' class='btn btn-secondary' id='modal-form-close' data-bs-dismiss='modal'>취소</button>`;
    }
    ...
    modalSetCloseText(modal_name, options.closeText || '취소');
...
function showQuestionDialog(title, content, options={}) {
    ...
    options.closeText = options.cancel_text || '취소';
