...
function editButton(url, text='编辑') {
...
function renderClipboard(s, prepend=false) {
    ...
    let clipString = `<span class="d-none d-xl-inline"><button class="btn clip-btn" type="button" data-bs-toggle='tooltip' title='复制到剪贴板'><em class="fas fa-copy"></em></button></span>`;
