...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Send</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Send');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Send';
    var close_text = options.close_text || 'Luk';
