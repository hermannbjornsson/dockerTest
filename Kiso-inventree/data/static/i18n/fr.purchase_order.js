...
function createPurchaseOrder(options={}) {
    ...
    constructForm('/api/order/po/', {
        ...
        title: options.title || 'Créer une commande d\'achat',
    });
}
        ...
        part: {
            ...
            onEdit: function(value, name, field, opts) {
                ...
                inventreeGet(`/api/company/part/${value}/`,
                    ...
                    if (pack_quantity != 1) {
                        var txt = `<span class='fas fa-info-circle icon-blue'></span> Nombre de paquet: ${formatDecimal(pack_quantity)} ${units}`;
...
function orderParts(parts_list, options={}) {
    ...
    <table class='table table-striped table-condensed' id='order-parts-table'>
        <thead>
            <tr>
                <th>Pièce</th>
                <th style='min-width: 300px;'>Pièce fournisseur</th>
                <th style='min-width: 300px;'>Commande d’achat</th>
                ...
                var onSupplierPartChanged = function(value, name, field, opts) {
                    ...
                    if (value != null) {
                        inventreeGet(
                            ...
                            if (pack_quantity != 1) {
                                var txt = `<span class='fas fa-info-circle icon-blue'></span> Nombre de paquet: ${pack_quantity} ${units}`;
    ...
    function renderLineItem(line_item, opts={}) {
        ...
        if (native_pack_quantity != 1) {
            ...
            <div class='alert alert-small alert-block alert-info'>
                Nombre de paquet: ${pack_quantity}<br>
        ...
        var sn_input = constructField(
            `items_serial_numbers_${pk}`,
            {
                ...
                help_text: 'Entrez les numéros de série pour les articles de stock entrants',
                icon: 'fa-hashtag',
            },
            {
                hideLabels: true,
    ...
    $(table).inventreeTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Référence du fournisseur',
            },
            {
                field: 'description',
                title: 'Description',
            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (row.supplier_part_detail && row.supplier_part_detail.pack_quantity_native != 1.0) {
                        ...
                        data += `<span class='fas fa-info-circle icon-blue float-right' title='Nombre de paquet: ${pack_quantity} - Total Quantity: ${total}${units}'></span>`;
                    }
