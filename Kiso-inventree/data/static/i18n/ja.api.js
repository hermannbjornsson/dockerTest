...
function showApiError(xhr, url) {
    ...
    case 400:
        ...
        message = 'API request returned error code 400';
        break;
    // Not authenticated
    case 401:
        title = 'Error 401: Not Authenticated';
        message = 'Authentication credentials not supplied';
        break;
    // Permission denied
    case 403:
        title = 'Error 403: Permission Denied';
        message = 'You do not have the required permissions to access this function';
        break;
    // Resource not found
    case 404:
