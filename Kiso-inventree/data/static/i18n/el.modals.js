...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Υποβολή</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Υποβολή');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Υποβολή';
    var close_text = options.close_text || 'Κλείσιμο';
