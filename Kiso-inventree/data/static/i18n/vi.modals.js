...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Gửi</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Gửi');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Gửi';
