...
function showApiError(xhr, url) {
    ...
    case 0:
        title = 'Ingen respons';
        message = 'Ingen svar fra InvenTree-serveren';
        break;
    // Bad request
    case 400:
        // Note: Normally error code 400 is handled separately,
        //       and should now be shown here!
        title = 'Feil 400: Ugyldig forespørsel';
        message = 'API-forespørsel returnerte feilkode 400';
        break;
    // Not authenticated
    case 401:
        title = 'Feil 401: Ikke autentisert';
        message = 'Autentiseringslegitimasjon ikke angitt';
        break;
    // Permission denied
    case 403:
        title = 'Feil 403: Tilgang nektet';
        message = 'Du har ikke de nødvendige tillatelsene for tilgang til denne funksjonen';
        break;
    // Resource not found
    case 404:
        title = 'Feil 404: Ressurs ikke funnet';
        message = 'Kan ikke finne den forespurte ressursen på serveren';
        break;
    // Method not allowed
    case 405:
        title = 'Feil 405: Metode ikke tillatt';
        message = 'HTTP-metode er ikke tillatt i URL';
        break;
    // Timeout
    case 408:
        title = 'Feil 408: Tidsavbrudd';
        message = 'Tidsavbrudd under forespørsel om data fra serveren';
        break;
    default:
        title = 'Uhåndtert feilkode';
        message = `Feilkode: ${xhr.status}`;
