        ...
        `/api/order/so/${order_id}/complete/`,
        {
            ...
            preFormContent: function(opts) {
                ...
                if (opts.context.pending_shipments) {
                    html += `
                    <div class='alert alert-block alert-danger'>
                    Bestillingen kan ikke fullføres da det finnes ufullstendige varepartier<br>
                    </div>`;
                }
            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (row.shipment_date) {
                        ...
                        html += makeEditButton('button-allocation-edit', pk, 'Rediger lagertildeling');
                        html += makeDeleteButton('button-allocation-delete', pk, 'Slett lagertildeling');
                    }
        ...
        columns.push(
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (available > 0) {
                        ...
                        html += `<span class='badge rounded-pill bg-danger'>Ingen lagerbeholdning tilgjengelig</span>`;
                    }
