            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Kopieer regel');
                            html += makeEditButton('button-edit', pk, 'Bewerk regel');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Verwijder regel', );
                        }
                    }
