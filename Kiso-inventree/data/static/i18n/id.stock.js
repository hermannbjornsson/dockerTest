...
function createNewStockItem(options={}) {
    ...
    options.successMessage = 'Item stok dibuat';
    ...
    if (!options.onSuccess) {
        options.onSuccess = function(response) {
            ...
            if (response.pk) {
                ...
                var details = `
                <br>Jumlah: ${response.quantity}
                <br>Nomor Seri: ${response.serial_numbers}
                `;
...
function locationDetail(row, showLink=true) {
    ...
    if (row.consumed_by) {
        text = 'Terpakai oleh order produksi';
            ...
            callback: function(data) {
                mergeStockItems(data, {
                    success: function(response) {
                        ...
                        showMessage('Stok item digabungkan', {
                            style: 'success',
                        });
                    }
                });
