...
function createNewModal(options={}) {
    ...
    if (!options.hideCloseButton) {
        buttons += `<button type='button' class='btn btn-secondary' id='modal-form-close' data-bs-dismiss='modal'>取消</button>`;
    }
    ...
    modalSetCloseText(modal_name, options.closeText || '取消');
...
function showQuestionDialog(title, content, options={}) {
    ...
    options.closeText = options.cancel_text || '取消';
